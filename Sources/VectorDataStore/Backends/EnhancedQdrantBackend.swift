...
// MARK: - Enhanced QdrantBackend with Retry and ID Hashing --------------------

/// Updated QdrantBackend with retry logic and proper ID hashing
public final class EnhancedQdrantBackend<Vector: VectorProtocol>: VectorDBBackend where Vector == [Float] {
